    ...
    <div class="coffeeshop-panel p-3 p-lg-4">
        <form method="GET" class="row g-2 align-items-end mb-3">
            ...
            <div class="col-lg-5">
                ...
                <select name="filter" class="form-select coffeeshop-form-control" onchange="this.form.submit()">
                        ...
                        <tr class="{{ $product->stock_quantity == 0 ? 'table-danger' : '' }}">
                            ...
                            <td>
                                <form action="{{ route('coffeeshop.inventory.adjust', $product) }}" method="POST" class="d-flex gap-2 flex-wrap">
                                    @csrf
                                    <select name="adjustment_type" class="form-select form-select-sm rounded-pill" style="width:120px;">
                                        <option value="restock">Restock</option>
                                        <option value="adjustment">Adjust</option>
                                    </select>
                                    <input type="number" name="quantity" class="form-control form-control-sm rounded-pill" style="width:80px;" required>
                                    <input type="text" name="notes" class="form-control form-control-sm rounded-pill" placeholder="Notes">
