                ...
                <div class="dashboard-list-scroll">
                    <div class="list-group">
                        ...
                        @foreach($roles as $role)
                            ...
                            @endphp
                            <div class="list-group-item d-flex justify-content-between align-items-center px-2 py-2 border-0 rounded-2 mb-1 dashboard-list-item-hover role-item {{ $role->is_active ? '' : 'text-muted text-decoration-line-through' }}" data-search-term="{{ strtolower($roleLabel) }}">
                                <span>{{ $roleLabel }}</span>
    ...
    <div class="col-lg-4">
        ...
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                ...
                <div class="search-container">
                    <i class="fa-solid fa-magnifying-glass search-icon"></i>
                    <input type="text" id="permission-search" class="form-control search-input" placeholder="Search permissions...">
                </div>
                ...
                <div class="dashboard-list-scroll">
                    <div class="list-group">
                        ...
                        @foreach($permissions as $permission)
                            <div class="list-group-item d-flex justify-content-between align-items-center px-2 py-2 border-0 rounded-2 mb-1 dashboard-list-item-hover permission-item {{ $permission->is_active ? '' : 'text-muted text-decoration-line-through' }}" data-search-term="{{ strtolower($permission->permission_key) }}">
                ...
                <div class="dashboard-list-scroll">
                    <div class="list-group">
                        ...
                        @foreach($users as $user)
                            ...
                            @endphp
                            <div class="list-group-item d-flex justify-content-between align-items-center px-2 py-2 border-0 rounded-2 mb-1 dashboard-list-item-hover user-item {{ $user->is_active ? '' : 'text-muted text-decoration-line-through' }}" data-search-term="{{ strtolower($user->full_name . ' ' . $roleLabel) }}">
                                <div>
                                    {{ $user->full_name }}
                                    @if(! $user->is_active)
...
<div class="card border-0 shadow-sm mt-4">
    ...
    <div class="card-header bg-white border-0 d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="search-container mb-0" style="width: 250px;">
            <i class="fa-solid fa-magnifying-glass search-icon"></i>
            <input type="text" id="matrix-search" class="form-control search-input py-1.5" placeholder="Filter permissions...">
        </div>
    </div>
