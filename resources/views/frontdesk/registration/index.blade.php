    ...
    <form method="POST" action="{{ route('frontdesk.registration.store') }}" id="registrationForm">
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label" for="folio_number">Guest Folio Number</label>
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('symbol') is-invalid @enderror" id="symbol" name="symbol">
                            @foreach(['CBO', 'VIP', 'CORP'] as $symbol)
                                <option value="{{ $symbol }}" @selected(old('symbol', $defaults['symbol']) === $symbol)>{{ $symbol }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <input type="text" class="form-control" id="room_base_rate_display" value="Select a room to view rate" readonly>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card-body">
                <div class="row g-3">
                    <div class="col-md-6">
                        <label class="form-label" for="billing_arrangements">Billing Arrangement</label>
                        <input type="text" class="form-control @error('billing_arrangements') is-invalid @enderror" id="billing_arrangements" name="billing_arrangements" value="{{ old('billing_arrangements') }}">
                    </div>

                    <div class="col-md-6">
                        <label class="form-label" for="special_arrangements">Special Arrangements</label>
                        <textarea class="form-control @error('special_arrangements') is-invalid @enderror" id="special_arrangements" name="special_arrangements" rows="3">{{ old('special_arrangements') }}</textarea>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label" for="num_free_breakfasts">No. of Free Breakfasts</label>
                        <input type="number" class="form-control @error('num_free_breakfasts') is-invalid @enderror" id="num_free_breakfasts" name="num_free_breakfasts" value="{{ old('num_free_breakfasts', 0) }}" min="0" max="20">
                    </div>

                    <div class="col-md-3">
                        <label class="form-label" for="breakfast_code">BF Code</label>
                        <input type="text" class="form-control @error('breakfast_code') is-invalid @enderror" id="breakfast_code" name="breakfast_code" value="{{ old('breakfast_code') }}" maxlength="20">
                    </div>
