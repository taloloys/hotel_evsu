...
class PosTabService
{
    ...
    public function formatTab(PosTab $tab): array
    {
        ...
        return [
            ...
            'credit_account_limit' => $tab->creditAccount ? (float) $tab->creditAccount->credit_limit : null,
            'credit_account_balance' => $tab->creditAccount ? (float) $tab->creditAccount->outstanding_balance : null,
            'credit_account_available' => $tab->creditAccount ? (float) $tab->creditAccount->available_credit : null,
